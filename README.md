This is a clone of the original repository from the ONTOX GitHub page, created for portfolio visibility. Find the orginal GitHub page [here](https://github.com/ontox-hu/Generative-re-tests) 
---
